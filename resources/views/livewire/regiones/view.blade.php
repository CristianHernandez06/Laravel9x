			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						@endif
						<div>
							<input wire:model='keyWord' type="text" class="form-control" name="search" id="search" placeholder="Search Regiones">
						</div>
						<div class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#createDataModal">
						<i class="fa fa-plus"></i>  Add Regiones
						</div>
					</div>
				</div>

				<div class="card-body">
						@include('livewire.regiones.modals')
				<div class="table-responsive">
								...
								<td width="90">
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li><a class="dropdown-item" onclick="confirm('Confirm Delete Regione id {{$row->id}}? \nDeleted Regiones cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Delete </a></li>
										</ul>
									</div>
								</td>
							</tr>
					...
					<div class="float-end">{{ $regiones->links() }}</div>
					</div>
				</div>
                <div class="row w-100">
					<div class="col-md-3">
					...
					<div class="col-md-3">
						<div class="card border-danger mx-sm-1 p-3">
							<div class="card border-danger text-danger p-3 my-card" ><span class="text-center fa-solid fa-tree-city" aria-hidden="true"></span></div>
							<div class="text-danger text-center mt-3"><h4>Regiones</h4></div>
							<div class="text-danger text-center mt-2"><h1><livewire:region-counter /></h1></div>
						</div>
					</div>
					<div class="col-md-3">
